...
<%@ MasterType VirtualPath="~/employeeMasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="btn-aligncenter">
        ...
        <div id="profilecontent">
            ...
            <br />
            <h3>
                <asp:Label ID="Label4" runat="server" Text="Nick Name" CssClass="reward-points"></asp:Label></h3>
            ...
            <br />
            <h3>
                <asp:Label ID="Label2" runat="server" Text="Point Balance" CssClass="reward-points"></asp:Label></h3>
        ...
        <div style="float: right; text-align: left;">
            <asp:Table ID="Table1" runat="server">
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Button ID="btnSetPrivacy" runat="server" Text="Privacy Settings" CssClass="btn-profile" Width="150px" />
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </div>
    ...
    <ajaxToolkit:ModalPopupExtender ID="popPrivacy" runat="server" TargetControlID="btnSetPrivacy" PopupControlID="divPrivacy" CancelControlID="btnCLOSE1" BackgroundCssClass="modalBackground"></ajaxToolkit:ModalPopupExtender>
        ...
        <asp:Table ID="EditProfile" runat="server" CssClass="table" Width="700px" HorizontalAlign="Center">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:RegularExpressionValidator ValidationGroup="profile" ID="FirstNameMessage" ForeColor="Red" runat="server" ControlToValidate="txtFirstName" ValidationExpression="^[a-zA-Z\s']{1,20}$" Text="No more than 20 characters" />
                ...
                <asp:TableCell></asp:TableCell><asp:TableCell>
                    <asp:RegularExpressionValidator ValidationGroup="profile" ID="MIMessage" ForeColor="Red" runat="server" ControlToValidate="txtMI" ValidationExpression="^[a-zA-Z\s']{0,1}$" Text="1 alphabetic characters" />
                </asp:TableCell></asp:TableRow><asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell></asp:TableCell><asp:TableCell>
                    ...
                    <asp:RegularExpressionValidator ValidationGroup="profile" ID="LastNameMessage" ForeColor="Red" runat="server" ControlToValidate="txtLastName" ValidationExpression="^[a-zA-Z\s']{1,30}$" Text="No more than 30 characters" />
                </asp:TableCell></asp:TableRow><asp:TableRow>
                <asp:TableCell>
        ...
        <h1>UPDATE PASSWORD</h1><asp:Table ID="TablePassword" runat="server" CssClass="table" Width="700px" HorizontalAlign="Center">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="password" ForeColor="Red" runat="server" class="auto-style1" ControlToValidate="txtNew1" ErrorMessage="*"></asp:RequiredFieldValidator>
                </asp:TableCell></asp:TableRow><asp:TableRow>
                <asp:TableCell></asp:TableCell><asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:DropDownList ID="dropPages" runat="server" Enabled="True" Width="200px" CssClass="textbox" AppendDataBoundItems="True">
                        ...
                        <asp:ListItem Text="Get Reward" Value="GetReward">
                        </asp:ListItem>
                        <asp:ListItem Text="User DashBoard" Value="DashBoard">
                        </asp:ListItem>
                ...
                </asp:TableCell></asp:TableRow></asp:Table></div><div id="divPrivacy" style="text-align: center;" class="popup">
        <h1>UPDATE PRIVACY SETTINGS</h1><asp:Button ID="Button2" runat="server" CssClass="btn-close" Style="background-image: url('http://icons.iconarchive.com/icons/iconsmind/outline/24/Close-icon.png'); background-repeat: no-repeat" />
        <asp:Button ID="Button1" runat="server" Text="Update" Width="100px" CssClass="button" OnClick="Button1_Click" /><asp:Table ID="Table3" runat="server"  HorizontalAlign="Center">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:CheckBox ID="GivePrivacy" runat="server" Text="Privacy on Giving Rewards" />
                </asp:TableCell></asp:TableRow><asp:TableRow>
                <asp:TableCell>
                    <asp:CheckBox ID="ReceivePrivacy" Text="Privacy on Receiving Rewards" runat="server" />
