<%@ Page Title="" Language="C#" MasterPageFile="~/SystemAdminMasterPage.master" AutoEventWireup="true" CodeFile="SytemAdminprofile.aspx.cs" Inherits="SytemAdminprofile" %>
<%@ MasterType VirtualPath="~/SystemAdminMasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div style="float:left; margin-left:20px;text-align:left;">
        <h2><asp:Label ID="lblFullName" runat="server" Text="" CssClass="reward-points"></asp:Label></h2>
        <br />
        <h3><asp:Label ID="Label1" runat="server" Text="Position" CssClass="reward-points"></asp:Label></h3>
        <asp:Label ID="lblPosition" runat="server" Text="" CssClass="reward-points"></asp:Label>
        <br />
        <h3><asp:Label ID="Label3" runat="server" Text="Contact" CssClass="reward-points"></asp:Label></h3>
        ...
        <asp:Table ID="EditProfile" runat="server" CssClass="table" Width="700px" HorizontalAlign="Center">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:RegularExpressionValidator ValidationGroup="profile" ID="FirstNameMessage" runat="server" ControlToValidate="txtFirstName" ForeColor="Red" ValidationExpression="^[a-zA-Z\s']{1,20}$" Text="No more than 20 characters" />
                ...
                <asp:TableCell>
                    ...
                    <asp:RegularExpressionValidator ValidationGroup="profile" ID="LastNameMessage" runat="server" ControlToValidate="txtLastName" ForeColor="Red" ValidationExpression="^[a-zA-Z\s']{1,30}$" Text="No more than 30 characters" />
                </asp:TableCell></asp:TableRow><asp:TableRow>
                <asp:TableCell>
        ...
        <h1>UPDATE PASSWORD</h1><asp:Table ID="TablePassword" runat="server" CssClass="table" Width="700px" HorizontalAlign="Center">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:RegularExpressionValidator ValidationGroup="password" ID="RegularNew1" runat="server" ControlToValidate="txtNew1" ForeColor="Red" ValidationExpression="((?=.*\d)(?=.*[a-z])(?=.*[\W]).{6,20})" Text="Must be 6-20 characters,at least one uppercase&lowercase&digital&special letter" CssClass="table" Display="Dynamic" />
                </asp:TableCell></asp:TableRow><asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:CompareValidator ValidationGroup="password" ForeColor="Red" ID="RegularNew2" runat="server" ControlToValidate="txtNew2" ControlToCompare="txtNew1" Type="String" Operator="Equal" Text="Password must be same as new password" />
                </asp:TableCell></asp:TableRow><asp:TableRow>
    ...
    <div id="divDefault" style="width:500px" class="popup">
        ...
        <asp:Table ID="Table2" runat="server" Width="211px" HorizontalAlign="Center"><asp:TableRow>
                <asp:TableCell>
                    ...
                    </asp:DropDownList><asp:CompareValidator ID="reqTB" runat="server" ControlToValidate="dropPages" ErrorMessage="*" ForeColor="Red"
