...
public partial class loginScreen : System.Web.UI.Page
{
    ...
    protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
    {
        ...
        command.CommandText = "select [PersonEmail],firstname,MI,lastname,loginCount,PointsBalance,PersonID,Password,[JobTitle],Privilege,status, BusinessEntityID,[DefaultPage] from person where person.[PersonEmail] = @Email";
            ...
            else
            {
                if (e.Authenticated)
                {
                        ...
                        else
                        {
                            ...
                            login.Parameters.AddWithValue("@LoginEmail", userName);
